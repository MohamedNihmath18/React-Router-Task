  ...
  return (
    <nav className="navbar navbar-expand-lg navbar-light bg-light">
      <div className="container-fluid">
        ...
        >
          <img width="110" height="53" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR_Kk1HqyVokzRzMayU0xc7aX68zE-Z7HYSCDHJwSqkxQ&s" className="img-fluid" alt="Guvi-blog-logo" />
        </Link>
        <button className="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
          <span className="navbar-toggler-icon"></span>
        </button>
        <div className="collapse navbar-collapse justify-content-center pe-lg-5 me-lg-5" id="navbarNavAltMarkup">
